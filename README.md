## Вопросы для фронтенд разработчика React.js

**Packages**
1) что такое yarn и npm?
1) файл package.json
	1) какие разделы для установки зависимостей и в чем их различие
	2) какой командой поставить зависимости только из dependencies
	3) что такое peerDependencies
	4) в какую секцию надо добавить typescript зависимость а в какую react ?
